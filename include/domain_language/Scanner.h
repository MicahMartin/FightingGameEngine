...
typedef enum {
  ...
  TOKEN_SET_NOGRAV_COUNT, TOKEN_SET_AIR_ACTION, TOKEN_SET_HIT_STUN, TOKEN_SET_INSTALL,
  TOKEN_SET_HIT_CANCEL, TOKEN_SET_WHIFF_CANCEL, TOKEN_SET_COUNTER, TOKEN_SET_BLOCK_STUN,
  TOKEN_RESET_ANIM,

  TOKEN_ACTIVATE_ENTITY, TOKEN_DEACTIVATE_ENTITY, TOKEN_GET_ENTITY_STATUS,
